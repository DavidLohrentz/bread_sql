...
DROP TABLE IF EXISTS parties, people_st, staff_st, organization_st, phones;
...
SELECT s.party_id, pe.first_name, p.party_name AS last_name, 
       s.ssn, s.is_active, s.hire_date, ph.phone_no AS mobile
FROM staff_st AS s
...
VALUES (3, 'i', '123-45-6789', TRUE, '2019-10-01'),
       (4, 'i', '121-21-2121', FALSE, '2017-12-30')
;
